...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gain_raw_label->setGeometry(QRect(540, 10, 51, 31));
        spinBox_gain_raw = new QSpinBox(GainRaw);
        spinBox_gain_raw->setObjectName("spinBox_gain_raw");
        spinBox_gain_raw->setGeometry(QRect(430, 11, 91, 31));
        QFont font1;
        ...
        label_7->setGeometry(QRect(10, 10, 91, 31));
        ...
        horizontalSlider_black_level->setGeometry(QRect(110, 20, 311, 16));
        ...
        black_level_label->setGeometry(QRect(540, 10, 51, 31));
        spinBox_black_level = new QSpinBox(BlackLevel);
        spinBox_black_level->setObjectName("spinBox_black_level");
        spinBox_black_level->setGeometry(QRect(430, 10, 91, 31));
        ...
        label_28->setGeometry(QRect(10, 11, 111, 31));
        ...
        label_29->setGeometry(QRect(10, 11, 141, 31));
